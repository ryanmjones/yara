rule emails_CERTUA8399
{
    ...
    strings:
        $str1 = {30 4b 48 52 67 74 47 41 30 4c 44 52 67 74 43 31 30 4c 50 52 6c 74 47 58 49 4e 43 6a 30 4c 72 52 67 4e 43 77 30 5a 66 51 76 64 43 34 4c 6e 42 6b 5a 69 35 73 62 6d 73 3d} // "Стратегії України.pdf.lnk" converted to Base64 then hex
